					...
					<div class="row-group">
						<div class="row">
							<div class="join">
								...
								@ 
								<input type="text" name="email22" id="email02" onkeyup="checkEmail(this.value);" style="width: 100px;"  value="naver.com" > 
								...
								<input type="text" id="confirm" class="form-control" name="confirm" placeholder="인증번호" >
								<button type="button" id="confirmok" disabled="disabled" required >인증하기</button>
