...
<script>
	...
	var defaultalertremovHandler=function(obj){
		...
		for(var i=0;i<s.length;i++){
			...
			if(s[i].moded==follow){
				...
				html+="<div role=\"alert\">";
				html+="<div align=\"center\"><small >"+"▼"+s[i].senddatejsp+"</small></div>";	
				html+="<a style=\"background-color: highlight;font-size: 15px;\" class=\"dropdown-item\" href=\"${pageContext.servletContext.contextPath}/board/board_detail.do?num="+s[i].num+"\">"+"<img class=\"photoo\" src=\"${pageContext.servletContext.contextPath}"+s[i].attach+"\" />"+s[i].id+s[i].content+"</a>";
				html+="</div>";
				}else{
					html+="<div role=\"alert\">";
					html+="<div align=\"center\"><small >"+"▼"+s[i].senddatejsp+"</small></div>";	
					html+="<a style=\"font-size: 15px;\" class=\"dropdown-item\" href=\"${pageContext.servletContext.contextPath}/board/board_detail.do?num="+s[i].num+"\">"+"<img class=\"photoo\" src=\"${pageContext.servletContext.contextPath}"+s[i].attach+"\" />"+s[i].id+s[i].content+"</a>";
					html+="</div>";
				}
			}
	...
	/* 	html+="<img src=\"${pageContext.servletContext.contextPath}"+obj.attach+"\" />" */
		...
		html+="</div>"+o;
			...
			html+="<div role=\"alert\">";
			html+="<div align=\"center\"><small >"+"▼"+obj.senddatejsp+"</small></div>";	
			html+="<a style=\"background-color: highlight;font-size: 15px;\" class=\"dropdown-item\" href=\"${pageContext.servletContext.contextPath}/board/board_detail.do?num="+obj.num+"\">"+"<img class=\"photoo\" src=\"${pageContext.servletContext.contextPath}"+obj.attach+"\" />"+obj.id+obj.content+"</a>";
			html+="</div>"+o;
			}else{
				html+="<div role=\"alert\">";
				html+="<div align=\"center\"><small >"+"▼"+obj.senddatejsp+"</small></div>";	
				html+="<a style=\"font-size: 15px;\" class=\"dropdown-item\" href=\"${pageContext.servletContext.contextPath}/board/board_detail.do?num="+obj.num+"\">"+"<img class=\"photoo\" src=\"${pageContext.servletContext.contextPath}"+obj.attach+"\" />"+obj.id+obj.content+"</a>";
				html+="</div>"+o;
			}
